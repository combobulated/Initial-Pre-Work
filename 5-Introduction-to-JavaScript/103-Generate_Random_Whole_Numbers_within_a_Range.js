...
like we did before, we can generate a random number that falls within
...
and returns a random number that's greater than or equal to myMin, and
is less than or equal to myMax, inclusive.

 ---- Commits --
Generate a random number between a range

Creates a function called randomRange that takes a range myMin and myMax
and returns a random number that's greater than or equal to myMin, and
is less than or equal to myMax, inclusive.
