...
/*  iterate through an array with a foor Loop
...
Remember that Arrays have zero-based numbering, which means the last
...
Declares and initializes a variable total to 0. Uses a for loop to add the
value of each element of the myArr array to total.
