...
We can also use the += operator to concatenate a string onto the end
 of an existing string variable.
...
----- Assignment ----
Build myStr over several lines by concatenating these
two strings: "This is the first sentence. "
...
---- Commits -----
Use += string contatenator for two strings

So as to make simple contatinate strings,
define a string var, myStr, then add to
it with +=
-----------------*/
// Example
