...
double quote. What happens when you need a literal quote: " or ' inside
f your string?
...
Assign myString a string with quotes

Uses backslashes to assign a string to the myStr variable so that
